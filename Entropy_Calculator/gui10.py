...
class SampEnGUI:
    ...
    def calculate_sampen(self):
        ...
        self.plot_sample_entropy(results, ref_results, r_values_per_window)
    ...
    def plot_sample_entropy(self, sampen_values, ref_sampen_values, r_values_per_window):
        plt.figure(figsize=(10, 6))
        ...
        for i, r in enumerate(r_values_per_window):
