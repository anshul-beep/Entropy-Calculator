...
class SampEnGUI:
    ...
    def create_widgets(self):
        ...
        ttk.Button(frame, text="Load CSV", command=self.load_csv).grid(row=9, column=0, columnspan=2, pady=10)

        ttk.Button(frame, text="Load Reference CSV", command=self.load_ref_csv).grid(row=10, column=0, columnspan=2, pady=10)
